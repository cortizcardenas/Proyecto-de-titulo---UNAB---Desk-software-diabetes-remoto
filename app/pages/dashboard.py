...
def dashboard():
    """The main dashboard page displaying glucose info after login."""
    return rx.el.div(
        navbar(),
        rx.el.main(
            rx.el.div(
                ...
                rx.el.div(
                    ...
                    rx.el.div(
                        ...
                        rx.el.div(
                            rx.el.h3(
                                "Estadísticas",
                                class_name="text-lg font-semibold mb-2 text-gray-700 dark:text-gray-200",
                            ),
                            rx.el.div(
                                rx.el.p(
                                    f"Glucosa Promedio: {GlucoseState.average_glucose:.1f} mg/dL",
