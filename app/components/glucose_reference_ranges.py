            ...
            rx.el.table(
                ...
                rx.el.tbody(
                    ...
                    rx.el.tr(
                        ...
                        rx.el.td("Rango preprandial recomendado", class_name="px-4 py-2 border-b bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300"),
                    ),
                    rx.el.tr(
                        ...
                        rx.el.td("Rango dentro de 2-3 horas después de comer", class_name="px-4 py-2 border-b bg-gray-50 dark:bg-gray-700 text-gray-700 dark:text-gray-300"),
                    ),
                    rx.el.tr(
                        ...
                        rx.el.td("Nivel alto, requiere monitoreo y posible ajuste", class_name="px-4 py-2 border-b bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300"),
                    ),
                    rx.el.tr(
                        ...
                        rx.el.td("Nivel críticamente alto - Buscar atención médica", class_name="px-4 py-2 bg-gray-50 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-br-lg"),
                    ),
                ),
